...
export function Hero() {
  return (
    <section
      ...
      className="-mt-16 flex h-[560px] w-full flex-col items-center overflow-hidden px-4 pt-[86px] text-center md:h-dvh md:min-h-[602px] md:max-h-[824px] md:justify-center md:px-0 md:pt-16"
    >
      <Image
